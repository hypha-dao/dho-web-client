...
q-page.page-home
  ...
  .row.full-width.q-mt-md(v-if="$q.screen.gt.md")
    .col-9.q-gutter-md
      ...
      .row.full-width.q-gutter-x-md
        how-it-works.col
        support-widget.col(:documentationURL="daoSettings.documentationURL" :discordURL="daoSettings.discordURL" :documentationButtonText="daoSettings.documentationButtonText")
    .col-3.q-ml-md
  ...
  .row.full-width(v-else-if="$q.screen.gt.sm").q-mt-md
    ...
    .col-6
        .row.q-gutter-y-md.q-ml-xs
          ...
          support-widget(:documentationURL="daoSettings.documentationURL" :discordURL="daoSettings.discordURL" :documentationButtonText="daoSettings.documentationButtonText").full-height.full-width
    .col-12.q-mt-md
  ...
  .row.full-width(v-else)
    .col-12
      ...
      .row.q-mt-md
        support-widget.full-width(:documentationURL="daoSettings.documentationURL" :discordURL="daoSettings.discordURL" :documentationButtonText="daoSettings.documentationButtonText")
</template>
