    ...
    .row
      div
        .row
          ...
          .h-h5.text-bold.q-mx-sm {{ $t('pages.upvote-election.steps.stepround1.voterBadge') }}
          .title-blue {{ $t('pages.upvote-election.steps.stepround1.assigned') }}
      ...
      div
        .row
          q-icon.card-icon(name="far fa-address-card" size="16px" color="white")
          .h-h5.text-bold.q-mx-sm {{ $t('pages.upvote-election.steps.stepround1.delegates') }}
          .title-blue {{ $t('pages.upvote-election.steps.stepround1.applicants') }}
