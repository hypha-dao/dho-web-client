...
q-page.page-proposals
  ...
  .row.q-py-md(v-if="$q.screen.gt.md")
    .col-9
      base-placeholder.q-mr-sm(v-if="!this.proposals.length && !this.filteredStagedProposals.length" title= "No Proposals" subtitle="Your organization has not created any proposals yet. You can create a new proposal by clicking the button below."
