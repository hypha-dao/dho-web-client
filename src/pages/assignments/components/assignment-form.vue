...
.q-pa-xs
  ...
  .edit-note(v-if="form.edit") If you modify your assignment you will propose your edits in a new vote. Once passed, your edits will merge with the existing assignment.
  q-editor.q-mt-sm(
