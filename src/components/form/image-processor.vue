...
.image-processor
  .row.flex.image-container
    ...
    .col-2.column.justify-between.items-end
      q-btn(icon="fas fa-redo-alt" @click="image.rotate(1)" color="accent" round size="sm")
        q-tooltip {{ $t('form.image-processor.rotate') }}
      q-btn(icon="fas fa-undo-alt" @click="image.rotate(-1)" color="accent" round size="sm")
        q-tooltip {{ $t('form.image-processor.rotate1') }}
      q-btn(icon="fas fa-search-plus" @click="image.zoomIn()" color="accent" round size="sm")
        q-tooltip {{ $t('form.image-processor.zoomIn') }}
      q-btn(icon="fas fa-search-minus" @click="image.zoomOut()" color="accent" round size="sm")
        q-tooltip {{ $t('form.image-processor.zoomOut') }}
      q-btn(icon="fas fa-arrows-alt-h" @click="image.flipX()" color="accent" round size="sm")
        q-tooltip {{ $t('form.image-processor.verticalMirror') }}
      q-btn(icon="fas fa-arrows-alt-v" @click="image.flipY()" color="accent" round size="sm")
        q-tooltip {{ $t('form.image-processor.horizontalMirror') }}
  q-separator.q-mt-md
  .row.flex.justify-end.q-mt-md
    q-btn.q-mr-sm(:label="$t('form.image-processor.cancel')" color="primary" @click="$emit('cancel')" flat)
