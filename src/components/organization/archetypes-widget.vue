...
<template lang="pug">
widget.full-width(more="more" :morePosition="isMobile ?'bottom': 'top'" :title="$t('organization.archetypes-widget.archetypes')" @more-clicked="$router.push({ path: `${$route.path}/assets/role` })" tooltip="Archetypes describe accountabilities and/or key tasks assigned to members of the DAO. These archetypes allow members to apply for a role.")
