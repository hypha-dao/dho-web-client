/**
 * Code taken from https://github.com/rikki-iki/postcss-rgb-filter/blob/master/index.js
 */
 ...
 * @returns {Color}
 */
export function rgbToFilter (rgbString) {
...
export function hexToFilter (hexString) {
